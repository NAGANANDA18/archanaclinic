        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-primary">Archana Clinic</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Specialized care in Neuro-Psychiatry and General Medical Services by Dr. Muralidhara K.A
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/services#neuro-psychiatry"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">muralianjanappa@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
